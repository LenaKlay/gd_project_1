...
K = 10**2 # 1000000000       # Carrying capacity for a spatial interval of size 1
...
# nb_sites = int(((v_cont*T/dx)//1000)*1000+1000)
nb_sites = 500


# Where to save datas
dir_save = f"stoch_save/datas/1D_{conv_timing}_K_{int(np.log10(K))}_dx_{dx}_s_{s}_r_{r}"
